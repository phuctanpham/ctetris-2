...
\begin{figure}[htbp]
    ...
    \fbox{\parbox{0.28\textwidth}{\centering\vspace{3.5cm}
        \textit{[Hình 9.1: gameConsole -- không có popup]}\vspace{3.5cm}}}
    \\[6pt]
    \textit{\small Hình 9.1: Màn hình gameConsole -- trạng thái bình thường}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox{0.28\textwidth}{\centering\vspace{3.5cm}
        \textit{[Hình 9.2: Popup Board -- SCORE DESC active]}\vspace{3.5cm}}}
    \\[6pt]
    \textit{\small Hình 9.2: Popup Board với sắp xếp động (v2)}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox{0.28\textwidth}{\centering\vspace{3.5cm}
        \textit{[Hình 9.3: Popup Stories -- chọn story]}\vspace{3.5cm}}}
    \\[6pt]
    \textit{\small Hình 9.3: Popup Stories (v2)}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox{0.28\textwidth}{\centering\vspace{3.5cm}
        \textit{[Hình 9.4: Popup Settings -- volume + màu khối]}\vspace{3.5cm}}}
    \\[6pt]
    \textit{\small Hình 9.4: Popup Settings (v2)}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox{0.28\textwidth}{\centering\vspace{3cm}
        \textit{[Hình 9.5: Màn hình Reload (Web only)]}\vspace{3cm}}}
    \\[6pt]
    \textit{\small Hình 9.5: Màn hình Reload -- chỉ xuất hiện trên bản Web}
\end{figure}
