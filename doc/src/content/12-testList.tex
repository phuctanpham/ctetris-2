...
\tcbox{CON\_TC\_009 \quad Gọi API Cloudflare (D1 + Durable Objects) cho Leaderboard}{
\textbf{Mã Test Case}       & CON\_TC\_009 \\ \hline
\textbf{Tiêu Đề}            & Gọi API Cloudflare (D1 + Durable Objects) cho Leaderboard \\ \hline
\textbf{Module / Phiên Bản} & gameConsole / v3 \\ \hline
\textbf{Loại Test}          & Manual + API Test \\ \hline
\textbf{Điều Kiện Tiên Quyết} & Kết nối Cloudflare (D1 + Durable Objects) đã cấu hình. API endpoint khả dụng. \\ \hline
\textbf{Các Bước Thực Hiện} &
...
\textbf{Trường Hợp Biên}    & API chậm/timeout, token Cloudflare (D1 + Durable Objects) sai, trường dữ liệu không đúng định dạng. \\ \hline
...
CORE\_TC\_016 & Gửi Điểm lên Cloudflare (D1 + Durable Objects)   & Kết thúc game, nhập tên, gửi data lên API & Dữ liệu gửi thành công, API phản hồi 200 \\ \hline
\end{tabularx}
\end{table}
