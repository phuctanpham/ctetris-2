...
% ====== GÓI XỬ LÝ ĐỒ HỌA & KÍCH THƯỚC ======
\usepackage{adjustbox}
\PassOptionsToPackage{edges}{forest}
\usepackage[edges]{forest}
\usepackage{svg}

% ====== TIKZ & CÁC THƯ VIỆN ĐẦY ĐỦ ======
\usepackage{tikz}
\usetikzlibrary{
    calc, arrows.meta, shapes.geometric, shapes.misc, shapes.arrows,
    positioning, fit, backgrounds, trees, matrix, shadows,
...
% Khai báo bí danh màu sắc an toàn
